<?php
    ...
    $countryarray = json_decode(file_get_contents('countryarraydata.json'), true);
    ...
    //UPDATE test counter:
    for ($l=0; $l<=375; $l++) {
        if ($countryarray[$l]['name']=='Testcounter'){
            $countryarray[$l]['count']++;
            break;
        }
    }
	...
	$test_country = 'countryarraydata' . '.json';
